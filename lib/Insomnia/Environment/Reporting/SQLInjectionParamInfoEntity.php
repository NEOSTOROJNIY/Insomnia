<?php
class Insomnia_Environment_Reporting_SQLInjectionParamInfoEntity
	extends Insomnia_Environment_Reporting_ParamInfoEntity
{
	 ...
	 */
	public function addVulnerableData($techniqueName, $techniqueType, $vulnerableValue = null, $vulnerableRequest = null, $resultQueue = null, $resultData = null) {
